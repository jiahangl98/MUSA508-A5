...
From the following map, we can tell there's no significant cluster of the high error, while the model4 generally perform well in the southwestern part of Jersey City, with low error
...
## Spatial Distribution of Space-Time Error
