...
```{r animate map temporal viz, message=FALSE, warning=FALSE, cache=TRUE}
library(gifski)
week13 <-
...
#animate(bikeshare_animation, duration=20, end_pause = 4, height = 1000, width = 700, fps = 6,renderer = gifski_renderer())

#anim_save("animation.gif", animation = bikeshare_animation, end_pause = 4, height = 1000, width = 700, fps = 6, renderer = gifski_renderer())
```
<center>
![Bikeshare Animation](https://raw.githubusercontent.com/jiahangl98/MUSA508-A5/main/animation.gif)
<figcaption>The Bikeshare Animation for Jersey City</figcaption>
</center>
